...
We are thrilled to bring <strong>Techspardha'23</strong> from 19th to 22nd January 2023.
<br><br>
...
Mob: ${options.phone}<br>
    ...
    case 'hackathon':
      return `<p>We are thrilled to bring Techspardha'23 from 19th to 22nd January 2023.<br><br> 

Techspardha is the annual techno-managerial festival of the National Institute of Technology, Kurukshetra.<br><br>

Consider it as an opportunity to spread your reach over 30NITs as it is one of North India's largest technical festivals witnessing participation from nationwide colleges and universities in addition to guest lectures from CEOs of reputable firms and professors of reputed institutions.Students are provided with an opportunity to showcase their skills and talents in a wide spectrum of events that test not only their technical know-how but also their managerial and soft skills. The events are aimed at encouraging students to come out of textbooks and apply their knowledge in a real-life setup.
<br><br>
With an ingenious crowd of 12,000 folks at work, we shall provide you with all the publicity you need. Our website, mobile app, local sources of endorsement, as well as our growing social media reach, will make this an even more fantastic opportunity for promoting your brand. Also, as per your requirement and target market, we offer various events such as Excalibur, Encoder, Hackathon, and many more.
<br><br>
<strong>Hackshetra’23</strong>, the annual hackathon of Techspardha'23 is back once again from <strong>16th to 17th January 2023</strong> providing developers all around the country an opportunity to participate and work on the trending tech themes and to come up with solutions for common day-to-day lives. 
<br><br>
<strong>Date: 16th to 17th January 2023 </strong>
<br><br>
...
Mob: ${options.phone}<br>
    ...
    case 'coding-platform':
      return `<p>Greetings from the National Institute of Technology, Kurukshetra, Haryana, India.<br><br>
Respected Sir/Ma'am,<br><br>
We are thrilled to bring Techspardha'23 from 19th to 22nd January 2023.<br><br> 
Techspardha is the annual techno-managerial festival of the National Institute of Technology, Kurukshetra.<br><br>
<br><br>
...
1. There will be ACM Style Ranklist- Users are ranked according to the most problems solved. <br>
